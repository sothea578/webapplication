<div class="content-wrapper">
    <form role="form" action="<?php echo base_url() . 'Destinations/create_destination' ?>" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea id="article" placeholder="Destination detail" class="col-xs-10 col-sm-5" name="detail"
                          rows="10"
                          value="<?php echo set_value('detail'); ?>">
                </textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="price" placeholder="Destination price" name="price" class="col-xs-10 col-sm-5"
