<div class="content-wrapper">
    <form role="form" action="<?php echo base_url() . 'Services/update_package?id=' . $result->pkg_id ?>"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="name" placeholder="" class="col-xs-10 col-sm-5" name="name"
                       value="<?php echo($result->pkg_name); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                    <textarea id="article" placeholder="Package description" class="col-xs-10 col-sm-5" name="desc"
                              rows="10"
                              value="<?php echo set_value('desc'); ?>"><?php echo($result->pkg_desc) ?>
                    </textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="file" id="pic" class="col-xs-10 col-sm-5"
                       name="pic" value="pic"/>
                <input type="hidden" id="old_pic" name="old_pic" value="<?php echo $result->pkg_pic ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <?php echo form_dropdown('id_serv', $serv, $result->id_serv); ?>
            </div>
        </div>
